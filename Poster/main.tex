...
{\includegraphics[scale=0.35]{udec.png}}
%
%----------------------------------------------------------------------------------------
%	TITLE AND AUTHOR NAME
%----------------------------------------------------------------------------------------
%
{ \bf  \huge {Oscilador Cuántico Forzados y Estados Coherentes} }
%\Large \it A} % Poster title
{\vspace{0.3em} \smaller Mario Urbina$^1$\\  % Author names
  
\smaller $^1$\it {Universidad de San Carlos de Guatemala}} % Author email addresses
{\includegraphics[scale=0.18]{logo_cepia.jpg}} % University/lab logo

%----------------------------------------------------------------------------------------
%	ABSTRACT
%----------------------------------------------------------------------------------------
\headerbox{Abstract}{name=abstract,column=0,row=0, span=3}{
\small{s} % the cross-correlation analysis between high energies and radio emission, towards an estimate for the location of the high energy emission region. 
}
%----------------------------------------------------------------------------------------
%	OTHER INSTRUMENTATION
%----------------------------------------------------------------------------------------
\headerbox{The 40m Telescope}{name=instruments,column=1,row=1,span=2,below=abstract}
...
%	MIXER vs. SAMPLERS
%----------------------------------------------------------------------------------------
\headerbox{Blazar study with PSD estimation for unevenly sampled data}{name=receiver,span=2,column=1,row=1, below=instruments}{
